...
# `market-survey-whitepaper` — EXAMPLES.md
...
- shape draft sections from real inputs
...
A strong survey whitepaper example should:
...
- saying or implying the survey is nationally representative
- naming or hinting at competitors
...
## Example 1: Turn raw survey findings into a sharp executive summary

### Input brief

```
Goal: Draft the executive summary for a gated whitepaper about workplace wellbeing.

Audience: Employers, brokers, trade media, HR decision-makers

Campaign objective: Show the business impact of delayed healthcare access and financial strain, while supporting PR coverage around workplace wellbeing.

Approved findings:
- 54% of employees surveyed said delays in getting care had affected their ability to work in the past year
- 77% said rising living costs had made it harder to prioritise everyday healthcare
- 46% said financial pressure had affected how well they could focus at work
- 71% said faster access to support would help them get back to work more quickly
- 87% said health and wellbeing benefits would make them more likely to stay with an employer

Guardrails:
- Do not imply national representativeness
- Keep product mentions soft
- Keep findings easy for journalists to lift
```
...
```
This report proves the UK workforce is in crisis and employers must act now.
```

Why this fails:

- “proves” is too absolute
- “UK workforce” sounds like a universal claim
- “must act now” sounds dramatic and advice-led

---

## Example 2: Create a journalist-friendly chapter opening from topline data
...
Chapter theme: The hidden cost of delayed healthcare access

Approved findings:
- 54% of employees surveyed said delays in getting care had affected their ability to work
- 31% said they had missed work because they could not get support in time
- 42% said they had tried to manage a health issue on their own because access was too slow

Goal:
Create a chapter opening that works in a whitepaper and gives PR teams clear lines to lift.

Guardrails:
- No sensationalism
- No medical advice framing
...
```
Britain’s healthcare system is failing workers, forcing huge numbers of people to suffer in silence.
```
...
- sounds sensational
- introduces a national claim the survey may not support
- “failing workers” is too loaded
...
- Some year-on-year comparisons are included
- Comparisons should be treated carefully because sample make-up and question wording may differ slightly

Guardrails:
- Do not say nationally representative
- Keep attribution clear
- Include caveat on comparisons
```
...
This report is based on survey findings commissioned by Health Shield and carried out by Censuswide.
...
- Clear about who commissioned and who carried out the research
- States dates and sample size simply
- Frames the survey properly
- Includes a careful comparison caveat
- Avoids overstating what the data can prove
...
```
This nationally representative research shows exactly how UK employees feel in 2026.
```

Why this fails:

- uses banned representativeness language
- “exactly how UK employees feel” overclaims
- sounds too broad and certain
...
```
Need: Final thoughts section

Context:
- Whitepaper is market-facing and gated
- Supports a press release
- Health Shield should be present, but softly
- Keep it helpful and insight-led

Approved themes:
- Employees value practical health support
- Early support matters
- Employers are looking for relevant, everyday ways to support wellbeing
- No hard sell
```
...
```
The answer is simple: employers should invest in Health Shield products now to solve these problems.
```
...
- too absolute
- turns the report into a sales message
...
```
Need: Pull-quote line for chapter page and PR reuse

Approved subgroup finding:
- 68% of employees aged 18 to 29 surveyed said financial pressure had affected how well they could focus at work
- Overall figure across all respondents was 46%

Goal:
Create a short, quotable line that highlights the subgroup finding without overstating it.

Guardrails:
- Do not imply all younger employees feel this way
- Keep it liftable for journalists
...
```
> Among employees aged 18 to 29 in our survey, 68% said financial pressure had affected how well they could focus at work.
```
...
- clearly frames the finding as a survey result
- keeps the line short and quotable
- avoids implying the subgroup represents all younger workers everywhere
...
```
Young workers are unable to cope with the cost of living crisis.
```

Why this fails:

- sweeping and stigmatising
- not supported by the data as written
- too dramatic
- not suitable for a careful whitepaper
...
```
Need: Intro paragraph for an expert commentary section

Expert:
Independent workplace wellbeing consultant

Purpose:
Introduce expert reflection after a chapter on financial pressure and delayed healthcare

Approved context:
- Expert is commenting on the themes in the survey
- Expert is not verifying the research methodology
- Keep the intro neutral and useful
```
...
- makes the expert’s role clear
- avoids overstating endorsement
- keeps the handover smooth
- sets up the commentary as reflection, not proof
...
```
[Expert name] confirms that the survey findings are an accurate picture of the whole UK workforce.
```

Why this fails:

- implies broad validation the expert may not be giving
- suggests national representativeness
...
## Final check before using an example pattern

Before reusing any structure from this file, check that your live draft:

- [ ] uses validated findings only
- [ ] frames findings as survey findings
- [ ] does not imply national representativeness
- [ ] avoids competitor references
